...
#Left Loops
left_loops = inp.addStructure('10kuhn.xyz', num_lloops)
...
#Bridges
bridges = inp.addStructure('10kuhn_bridge.xyz', num_bridges)
inp.addStructureConstraintInsideBox(x_min, y_min, z_min, x_max, y_max, z_max)
bridges.pickAtoms(1)
...
#Right Loops
right_loops = inp.addStructure('10kuhn.xyz', num_rloops)
inp.addStructureConstraintInsideBox(x_min, y_min, z_min, x_max, y_max, z_max)
